...
//rainbownews excerpt function
if (!function_exists('rainbownews_excerpt')) :
...
// rainbownews the custom logo fuction
...
function rainbownews_footer_copyright_info()
{
    ...
    $default_footer_value = '<p class="nnc-left">' . sprintf(esc_html__(' &copy; %1$s %2$s. All Right Reserved. ', 'rainbownews'), $site_link, date_i18n('Y')) . sprintf(esc_html__('| Powered by %s.', 'rainbownews'), $wp_link) . '</p><p class="nnc-right">' . sprintf(esc_html__('Built by %s.', 'rainbownews'), $tm_link) . '</p>';
