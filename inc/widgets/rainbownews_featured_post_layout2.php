 ...
 * @package RainbowNews
 *
 * Rainbownews Featured Post Layout2 Widget Section
 */
...
class Rainbownews_featured_post_layout2 extends WP_Widget
{
    ...
    {
        $widget_ops = array(
            'classname'      => 'rainbownews_featured_post_layout2',
            'description'    => __('Display latest posts or posts of specific category.', 'rainbownews'));

        parent::__construct( 'rainbownews_featured_post_layout2', '&nbsp;' . __(' NNC: News [ Layout 2 ] ', 'rainbownews'), $widget_ops);
    }// end of construct.
                    ...
                    while ($get_featured_posts->have_posts()):$get_featured_posts->the_post();
                        ...
                        <div class="nnc-category-single <?php echo has_post_thumbnail() ? '' : 'nnc-no-image'; ?>">
                            ...
                            <div class="nnc-category-dtl">
                                ...
                                <?php if ($i == 1) : ?>
                                    <p> <?php echo rainbownews_excerpt(get_the_content(), 200); ?></p>
                                <?php endif; ?>
